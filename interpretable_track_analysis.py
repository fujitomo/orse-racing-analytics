...
【目的】
機械学習の予測精度よりも「なぜその組み合わせで勝ちやすいのか」を重視し、
競馬関係者が納得できる説明と実用的な知見を提供する分析

【主な機能】
1. 競馬場×能力ランク×枠順の3次元クロス分析
2. 統計的有意性検定による科学的根拠の提供
3. 解釈しやすいカテゴリ変数の自動生成
4. 実用的なactionable insightsの生成
5. 日本語での分かりやすいレポート出力

【特徴】
- ブラックボックス化を避け、すべての分析過程が透明
- 競馬の実務経験に基づく解釈可能な変数設計
- 統計的検定による客観性の担保
- 即座に活用できる具体的な推奨事項を提供

【入力データ】
- export/with_bias フォルダ内のSED*_formatted_with_bias.csvファイル
- 必須カラム: 場名、年、馬番、着順、IDM、素点

【出力】
- 解釈性重視レポート.md: 実用的な知見をまとめたレポート
- 解釈性重視分析.png: 基本的な可視化
- 勝率ヒートマップ.png: 競馬場×能力ランク別勝率
